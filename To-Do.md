...
analyzer traces, 1.9 min).
  ...
  - [x] B7a: `sim/bandgap.py` two-PNP core (mult 1:8) + gate test + `metrics/tempco.py` (Vref sum + box ppm/°C) + hand-golden unit tests. Evidence: ruff + mypy clean, tempco+bench files green, full base 429+50.
  - [-] B7b: `_run_b7` (K + tempco discovered live on EDA) + live tests + EDA proof.
