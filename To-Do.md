...
- [-] **R0 Trust Core — AnalogBench** (R0-1 `ca588c7`; R0-2a `1695af6`, R0-2b `0e74696`; R0-3a `28be619`; base 346+37)
  ...
  - [-] R0-3b B4 cascode (runner over new `sim/cascode.py` fixture): Vbcas search reversed live (1.1 rail-hugging beats intended 0.9 by +4 gain, physically correct — higher Vbcas maximizes swing); dual DC+AC assertions required (AC-only lies: 1.6 DC vs 13.5 AC through drain resistor). MEASURED DC 12.999 == AC 12.989 at trip 0.85V, clears same-size plain-CS 9.1 action threshold 10, headroom span 0.205V, rails 0.091–1.800. Base 346+37 green; EDA bench file proof pending.
