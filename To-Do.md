...
- [-] **Active: canonical EDA pivot (ADR-036)**
  ...
  - [x] Track B2: "Run All Corners" rewired (was miswired to nominal sim) + Corner Results rows + click-to-view + Playwright. Evidence: tsc + vite build green; corners e2e 1 passed live (5/5 rows, SS click-through to analyzer traces, 1.9 min).
