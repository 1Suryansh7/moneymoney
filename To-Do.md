...
- [ ] Tutor RFC (after optimizer UI green): failure-explanation-first, citation refusal, proposal gates.
  ...
  - [-] v0-backend commit: `ai/tutor.py` keyword classifier + `EngineV01.chat` + POST /copilot/chat + `tests/test_tutor_refusal.py` (20-prompt Eval). (COMMITTED: base 412+47 green.)
