...
| 3H offset | pending | `extract_offset` (Vid at Vod zero) + `diff_pair_nmos` fixture (mirror load) | `metrics/offset.py`, `sim/diff_pair.py`; tests in `test_offset.py` (exact 3 mV crossing, 5 rejections). Symmetric 1.9e-10 V; 2:1 mismatch −77 mV correct sign. Checkpoint CONFIRMED 2026-09-07 |
