...
PHASE_MARGIN: Final = MetricContract(
    ...
    name="Phase Margin",
    definition="Angle 180° + Phase(T(jω)) at unity loop-gain frequency (0 dB return ratio).",
    required_analysis="ac",
    ...
    formula_description="180.0 + phase(T(f_ugb)) in degrees.",
    sign_convention="Positive degrees (PM > 0 indicates stable negative feedback)",
    units="deg",
